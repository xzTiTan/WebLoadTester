...
**Версия документации:** v2.2 11.02.2026
...
- Ключевые якоря: [01 Канон](docs/01_КАНОН_ПРОЕКТА_И_ТЗ_WebLoadTester_v1.1_02.02.2026.md), [02 Техспека](docs/02_ТЕХ_СПЕЦИФИКАЦИЯ_АРХИТЕКТУРА_МОДУЛИ_ДАННЫЕ_ОТЧЕТЫ_WebLoadTester_v1.1_02.02.2026.md).
...
Полные детали — в [docs/02 (раздел «Модули»)](docs/02_ТЕХ_СПЕЦИФИКАЦИЯ_АРХИТЕКТУРА_МОДУЛИ_ДАННЫЕ_ОТЧЕТЫ_WebLoadTester_v1.1_02.02.2026.md).
