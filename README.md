...
**Версия документации:** v2.15 16.02.2026
...
- Ключевые якоря: [01 Канон](docs/01_CANON.md), [02 Архитектура и данные](docs/02_ARCHITECTURE_AND_DATA.md), [03 UI-канон](docs/03_UI_CANON.md).
- Полное связное описание системы: [08 Full Software Description](docs/08_FULL_SOFTWARE_DESCRIPTION.md).
