...
**Назначение:** фиксирует архитектуру, модули, жизненный цикл прогона, данные и отчёты.  
**См. также:** [01_CANON.md](01_CANON.md), [03_UI_SPEC.md](03_UI_SPEC.md), [04_CODE_MAP.md](04_CODE_MAP.md), [05_GLOSSARY.md](05_GLOSSARY.md).

## 0. Связанные документы
- Канон требований: `01_CANON.md`
- UI-спецификация: `03_UI_SPEC.md`
...
Именование конфигураций модулей использует единый каталог `ModuleCatalog` (поле `ModuleSuffix`): итоговое имя всегда формируется как `UserName_ModuleSuffix` без пробелов в `UserName`.
...
- Входы: требования из `01_CANON.md`, UX-правила из `03_UI_SPEC.md`.
- Выходы: contracts/DDD/Core, обновления `04_CODE_MAP.md`, критерии для `06_TEST_PLAN.md`.
