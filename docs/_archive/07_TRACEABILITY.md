...
**Назначение:** связывает требования, код и проверки.  
**См. также:** [01_CANON.md](01_CANON.md), [02_TECH_SPEC.md](02_TECH_SPEC.md), [06_TEST_PLAN.md](06_TEST_PLAN.md).

## 0. Как читать матрицу
- FR = функциональное требование
- NFR = нефункциональное требование
- CODE = ключевые компоненты кода
- TEST = пункт из `06_TEST_PLAN.md`
...
- Входы: требования из `01_CANON.md`, тест-план из `06_TEST_PLAN.md`.
- Выходы: проверяемые связи «требование → реализация → тест».
