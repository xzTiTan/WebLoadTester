...
- `01_КАНОН_ПРОЕКТА_И_ТЗ...` — решения, требования, границы, критерии приёмки (этот файл)
- `02_ТЕХ_СПЕЦИФИКАЦИЯ...` — архитектура, модули, данные, отчёты, жизненный цикл прогона
- `03_UI_СПЕЦИФИКАЦИЯ...` — экраны, элементы UI, UX-правила, поведения
- `04_КАРТА_КОДА_И_СВЯЗИ...` — карта файлов/классов/потоков данных
- `05_ГЛОССАРИЙ...` — единые термины
- `06_ПЛАН_ИСПЫТАНИЙ...` — сценарии демонстрации и тест-план
- `07_МАТРИЦА_ТРАССИРУЕМОСТИ...` — требование → реализация → испытание
- `08_CODEX_ПРОМПТЫ_И_ЖУРНАЛ_ИЗМЕНЕНИЙ...` — правила работы, промпты, changelog
- `09_ВКР_ЕДИНЫЙ_ТЕКСТ_ЧЕРНОВИК...` — структура пояснительной записки (черновик)
...
> Примечание: состав модулей и IDs фиксированы; детали реализации — в `02_ТЕХ_СПЕЦИФИКАЦИЯ...` и `04_КАРТА_КОДА...`.

---

## 5. Ключевые сущности и понятия (минимум)
(Полные определения — в `05_ГЛОССАРИЙ...`.)
