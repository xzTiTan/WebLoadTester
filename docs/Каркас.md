...
## ⚠️ Статус документа (Legacy/Archive)
- Этот файл сохранён как **архивный справочный материал** по раннему UI-этапу.
- Документ **не является источником истины** и не должен использоваться как активный якорный документ.
- Актуальные требования и инварианты фиксируются в `docs/INDEX.md` и якорных документах `docs/02_*`, `docs/03_*`, `docs/05_*`.
- При противоречиях приоритет всегда у `docs/INDEX.md`.
