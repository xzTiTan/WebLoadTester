...
## Дополнение: что именно считать “UI-истиной”
- Русские названия вкладок/кнопок/полей (как в этом файле).
- Правила компоновки (ScrollViewer, отсутствие наложений).
- Единый паттерн экранов модулей (Секции 1–6).
